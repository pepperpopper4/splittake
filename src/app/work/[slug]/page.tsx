...
export default async function ProjectPage({ params }: Props) {
  ...
  return (
    <article className="mx-auto max-w-7xl px-5 py-14 md:px-8 md:py-20">
      ...
      <div className="grind-panel mb-10 p-2 md:p-3">
      ...
      <div className="grid gap-10 md:grid-cols-[1.4fr_0.8fr]">
        <div>
          <h2 className="display mb-3 text-xl text-warm">About the piece</h2>
      ...
      <nav className="mt-16 flex flex-wrap items-center justify-between gap-4 border-t border-paper/10 pt-8">
        {prev ? (
          <Link
            href={`/work/${prev.slug}`}
